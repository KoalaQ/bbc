    ...
    <center>
        ...
        <div id="tabs">
          <ul>
            ...
            <span style="color:red"> <c:if test="${param.error==0}">验证码错误!</c:if></span>   
              <span style="color:red"> <c:if test="${param.error==1}">连接已过期!</c:if></span>   
       ...
       <div id="tabContent">
            ...
            <form action="/bbc/changePassword.do"  method="post" >
                 	<table>
                 		<tr>
                 			<td>密码：</td>
                 			<td> <input type="text" id="password" name="password" class="outerBorder" onblur="vailUser(0,this.value)"/></td>
                 		</tr>
                 		<tr>
                 		...
                 		<tr>
                 			...
                 			<input type="submit" id="submit" value="更改"  disabled="true"/></td>
